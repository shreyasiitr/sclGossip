...
public class RandomGossipManager extends GossipManager {
  public RandomGossipManager(String cluster, String address, int port, String id, ArrayList<ArrayList<String>> log,
    ...
    super(OnlyProcessReceivedPassiveGossipThread.class, RandomActiveGossipThread.class, cluster,
            address, port, id, log, settings, gossipMembers, listener);
  }
}

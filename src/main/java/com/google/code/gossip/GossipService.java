...
public class GossipService {
  ...
  public GossipService(StartupSettings startupSettings) throws InterruptedException,
    ...
    this(startupSettings.getCluster(), InetAddress.getLocalHost().getHostAddress(), startupSettings
            .getPort(), startupSettings.getId(), startupSettings.getLogInstance(),startupSettings.getGossipMembers(),
   ...
   * @throws UnknownHostException
   */
  public GossipService(String cluster, String ipAddress, int port, String id, ArrayList<ArrayList<String>> log,
          List<GossipMember> gossipMembers, GossipSettings settings, GossipListener listener)
          throws InterruptedException, UnknownHostException {
    gossipManager = new RandomGossipManager(cluster, ipAddress, port, id, log, settings, gossipMembers,
            listener);
  }
